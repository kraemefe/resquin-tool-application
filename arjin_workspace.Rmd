...
consistency and reliability of their responses. Mahalanobis distance
helps identify these respondents whose patterns deviate substantially
from the group norm.

<!-- Should we mention that we will closely inspect those outliers later in the tutorial?-->
...
trust_distributions_outliers_flagged <- flag_outliers(trust_distribution, c("ii_mean", "ii_median", "ii_sd", "mahal"))
...
outlier_data <- trust_distributions_outliers_flagged[, c("outlier_ii_median", "outlier_ii_mean", "outlier_ii_sd", "outlier_mahal")]
...
# Use the function to flag outliers
trust_respstyle_outliers_flagged <- flag_outliers(trust_respstyles, c("MRS", "ARS", "DRS", "ERS", "NERS"))
...
```{r}
# Select the outlier columns
outlier_data <- trust_respstyle_outliers_flagged[, c("outlier_MRS", "outlier_ARS", "outlier_DRS", "outlier_ERS", "outlier_NERS")]
