...
<!-- this following code and interpretation paragraph would then be obsolete and we could delete it :-) -->
```{r}
...
<!-- Let's not look at non-extreme responses style - I personally think it would be confusing to interpret it together with extreme response style since it's the inverse of it -->
