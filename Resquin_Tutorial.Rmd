...
<!-- Fill in rest of the NEP Scale: you can find it in the codebook of the GESIS Panel Campus File (buzzword for search: "NEP") -->
...
pacman::p_load(readr, resquin, dplyr, ggplot2) # I already deleted duplicates but do we really need all of them? I suggest we keep it as concise as possible and see again after finalizing the tutorial which packages are really needed
