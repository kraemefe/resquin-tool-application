...
of the institutional trust scale. Respondents who (almost) continuously select middle
...
the sample who showed an unusual extent of mid-point and extreme responding. These respondents should be flagged
as their response behavior calls for additional checks regarding data quality.
...
**Acquiescence response style:** High extreme response rates may represent
polarized opinions rather than poor data quality.

**Outliers:** Indicators such as acquiescence and disacquiescence
offer insights into response tendencies but should be interpreted
contextually.

**Recommendation:** Removing responses based on perceived quality
