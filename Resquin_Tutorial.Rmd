...
# let's maybe calculate more summary statistics
...
<!-- Side remark -->
Apart from a binary measure indicating the selection of the identical answer versus to selecting at least two different responses across a set of items is only one of several possible operationalizations of straightlining or non-differentiation. For an overview of the different possible operationalizations used in research, see @Kim_ et al., 2019.
...
mean_values <- NEP_distribution_long %>%
  group_by(Indicator) %>%
  summarize(mean_value = mean(Value, na.rm = TRUE))  # Also here, let's calculate more summary statistics
...
14. Humans will eventually learn enough about how nature works to be
    able to control it [*(Negatively worded)*]{.underline}
15. If things continue on their present course, we will soon experience
    a major ecological catastrophe [(*Positively worded)*]{.underline}
