...
-   the \<span data-toggle="popover" data-content="The mahalanobis
    distance captures how different each respondent's pattern of answers
    is from the "typical" response pattern of all respondents. A higher
    score indicates that the respondent’s answers are more unusual or
    inconsistent compared to the other respondents."
    style="text-decoration: underline; cursor: pointer;"\> mahalanobis
    distance </span> per respondent (mahal)
