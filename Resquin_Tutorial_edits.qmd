...
<!--connection sentence added-->

You can navigate between the tabs below to explore the two different multi-item scales that we will use for data quality analysis in this tutorial.
...
<!--I could not add the suggestion part here, but check it again-->
