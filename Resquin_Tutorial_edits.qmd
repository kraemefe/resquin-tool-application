...
trust_responses_df <- cbind("Response" = rownames(trust_responses_df), trust_responses_df)
rownames(trust_responses_df) <- NULL

# Print the table with styling
trust_responses_df %>%
  kable("html", escape = FALSE, caption = "Summary of Response Codes Across Political Trust Scale Items") %>%
...
<!-- changed info box as callout-->

::: {.callout-note title="Package-Specific Feature"}
By specifying the option `min_valid_responses`, respondents with
...
Knowing how to assess and interpret indicators of
