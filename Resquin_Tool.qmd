...
biblio-style: apa
editor: 
  citation: "Kraemer, Fabienne, Arjin Eser, Çağla Yıldız. and Matthias Roth (2024). *Assessing Response Quality and Careless Responding in multi-Item Scales*. GitHub Repository. URL:  https: //github.com/kraemefe/resquin-tool-application"
  markdown: 
    wrap: 72
prefer-html: true
---
...
```{r install resquin, eval=FALSE, message=FALSE, warning=FALSE, results='hide'}
# Installing resquin
install.packages("resquin")
```
```{r load resquin, message=FALSE, warning=FALSE, results='hide'}
...
```{r install CRAN packages, eval=FALSE, message=FALSE, warning=FALSE, results='hide'}
